...
file_path = os.path.expanduser("~/aqualotus/frontend/src/components/ui/NotificationBell.jsx")

new_code = """import { useState, useRef, useEffect } from 'react'
    ...
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      <button
        ...
        style={{
          ...
          cursor: 'pointer', color: 'rgba(255,255,255,0.92)', fontSize: '1.2rem', padding: '6px 8px',
...
print("زنگوله ادمین با استایل شناور مطلق فیکس شد!")
