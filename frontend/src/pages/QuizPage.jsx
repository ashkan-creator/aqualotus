...
const QuizPage = () => {
  ...
  return (
    <Container className='py-4 aq-quiz-page'>
      <Helmet>
      ...
      {!submitted ? (
        <Row className='justify-content-center'>
          <Col xs={12} md={8} lg={6}>
            ...
            <Card className='text-center p-4 border-0 shadow-sm rounded-4 aq-quiz-card'>
              <Card.Body>
        ...
        <>
          <h3 className='text-center mb-4 aq-page-title'>گیاه‌های پیشنهادی برات 🌿</h3>
          {isLoading ? (
            <Loader />
          ) : error ? (
