      ...
      {!keyword && !activeFilterCount && (
        <>
          ...
          <BlogHighlightsSlider />
                    <Link to='/quiz' className='d-block text-decoration-none mt-2 mb-3'>
            <div
              className='position-relative overflow-hidden aq-quiz-banner-img'
              style={{
                backgroundImage: "url('/images/quiz-banner.jpg?v=5')",
            ...
            >
              ...
              <div className='aq-quiz-banner-content text-center d-flex flex-column align-items-center px-3'>
                <h4 className='mb-1 aq-quiz-banner-title' style={{ color: '#fff', textShadow: '0 1px 3px rgba(0,0,0,0.95), 0 2px 10px rgba(0,0,0,0.85)' }}>
                  گیاه مناسب آکواریومت رو پیدا کن!
                </h4>
                <p className='mb-0 aq-quiz-banner-text' style={{ color: '#fff', opacity: 0.95, textShadow: '0 1px 3px rgba(0,0,0,0.95), 0 2px 10px rgba(0,0,0,0.85)' }}>
                  با چند سوال ساده، بهترین گیاه‌ها رو برات پیشنهاد می‌دیم
                </p>
                <p className='mb-0 mt-1 aq-quiz-banner-cta' style={{ color: '#fff', textShadow: '0 1px 3px rgba(0,0,0,0.95), 0 2px 10px rgba(0,0,0,0.85)' }}>
                  کلیک کنید
                </p>
              </div>
            </div>
