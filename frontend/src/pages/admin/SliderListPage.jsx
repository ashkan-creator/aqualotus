...
const SliderListPage = () => {
  ...
  const { data: sliders, isLoading, refetch } = useGetAllSlidersQuery(activeLocation)
        ...
        <>
          ...
          <div className='d-md-none'>
            <Row className='g-3'>
              ...
              {sliders?.length === 0 && (
                <Col xs={12}><p className='text-center text-muted py-3'>اسلایدی برای این بخش ثبت نشده</p></Col>
              )}
            </Row>
          </div>
        </>
