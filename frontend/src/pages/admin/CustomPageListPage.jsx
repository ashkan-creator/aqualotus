              ...
              <tbody>
                {pages?.map((page) => (
                  <tr key={page._id}>
                    ...
                    <td>
                      <a href={`/pages/${page.slug}`} target='_blank' rel='noreferrer' className='btn btn-sm btn-outline-secondary ms-1'>
                        <FaExternalLinkAlt />
                      </a>
                ...
                <Col xs={12} key={page._id}>
                  <Card className='p-3'>
                    ...
                    <div className='d-flex gap-2 mt-2'>
                      <a href={`/pages/${page.slug}`} target='_blank' rel='noreferrer' className='btn btn-sm btn-outline-secondary flex-grow-1'>
                        مشاهده
                      </a>
